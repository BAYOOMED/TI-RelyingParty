...
StartupValidator.ValidateRedirectUris(fedOptions.RedirectUris ?? [$"{fedOptions.Issuer}/cb"], builder.Environment.IsDevelopment());
StartupValidator.ValidateOrganizationName(fedOptions.OrganizationName);
